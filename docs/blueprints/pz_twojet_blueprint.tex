...
\begin{verbatim}
def eval_pz_twojet(model, X, remez_degree, options):
...
\begin{verbatim}
def pz_twojet_tanh(layer, jet, remez_degree, options):
    Z = jet.Y
    Jz = jet.J
    Hz = jet.H
    ...
    for i in range(Z.output_dim):
        ...
        p_i = compute_remez_tanh(Ii, degree=remez_degree)
...
jet = model.eval_pz_twojet(X, remez_degree=5)
